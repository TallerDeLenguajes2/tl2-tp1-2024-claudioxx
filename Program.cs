...
void menu(){
    ...
    switch (opcion){
        case 1: Helper.altaPedido(unaCadeteria);                
                break;
        case 2: unaCadeteria.mostrarPedidos();
                ...
                unaCadeteria.asignarCadeteAPedido(numCadete,numPedido);
                break;
        case 3: Helper.cambiarEstado(unaCadeteria);
                break;
        case 4: //Helper.reasignarPedidoACadete(unaCadeteria);
                break;
        case 5: unaCadeteria.mostrarCadetes();
                break;
        case 6: unaCadeteria.mostrarPedidos();
                break;
